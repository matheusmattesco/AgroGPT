    ...
    public partial class MLModel
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"N", @"N"),new InputOutputColumnPair(@"P", @"P"),new InputOutputColumnPair(@"K", @"K"),new InputOutputColumnPair(@"temperature", @"temperature"),new InputOutputColumnPair(@"humidity", @"humidity"),new InputOutputColumnPair(@"ph", @"ph"),new InputOutputColumnPair(@"rainfall", @"rainfall")})      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=4,MinimumExampleCountPerLeaf=29,NumberOfTrees=18,MaximumBinCountPerFeature=184,FeatureFraction=0.717824683477689,LearningRate=0.999999776672986,LabelColumnName=@"label",FeatureColumnName=@"Features"}),labelColumnName: @"label"))      
